...
mode.addEventListener('click', () => {
    ...
    if(darkMode){
        ...
        document.documentElement.style.setProperty('--secondary-color', '#cc9900');
        document.documentElement.style.setProperty('--third-color', '#1a1300');
...
let locations = ['SYMBIOSIS', 'DREAMS', 'WINDING STAIRS', 'FUTURE WORLD', 'ORGANIC', 'DARK MATTERS'];
...
previous.addEventListener('click', () => {
    let num = +image.style.backgroundImage.split('/')[2][0];
     ...
     counter.querySelector('p').innerText = `${num}/6`;
